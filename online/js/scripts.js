...
$(function(){
 ...
 /*
	FlipClock.Lang.Custom = { days:'Dias', hours:'Horas', minutes:'Minutos', seconds:'Segundos' };
	var opts = {
...
if(window.innerWidth < 767){
	...
	var countdown = 1505835000 - ((new Date().getTime())/1000); // from: 09/13/2017 10:38 am -0300
